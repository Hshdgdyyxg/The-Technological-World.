...
<head>
  ...
  <title>Auth App - Integrated Reset</title>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    /* VIEW MANAGEMENT */
    .view-section { display: none; width: 100%; height: 100vh; align-items: center; justify-content: center; flex-direction: column; }
    ...
    .card { background: white; padding: 50px; border-radius: 10px; box-shadow: 0 10px 20px rgba(0,0,0,0.1); text-align: center; width: 400px; max-width: 90%; }
...
<body>
      ...
      <div class="form-container sign-up-container">
        <form id="signUpForm">
          ...
          <div class="social-container">
            <a href="#" onclick="loginWithGoogle()"><i class="fab fa-google-plus-g"></i></a>
          </div>
  ...
  <div id="reset-view" class="view-section">
    <div class="card">
      ...
      <form id="resetForm" style="padding: 0;">
        <input type="email" id="resetEmail" placeholder="Email Address" required />
        <button type="submit">Send Reset Link</button>
      </form>
      <br>
      <a href="#" onclick="switchView('auth-view')" style="color: #333; font-size: 13px; text-decoration: none;">← Back to Login</a>
    </div>
  </div>
  ...
  <script>
    ...
    auth.onAuthStateChanged(user => {
      if (user) {
        ...
        // Only switch to auth-view if we aren't in the reset-view
